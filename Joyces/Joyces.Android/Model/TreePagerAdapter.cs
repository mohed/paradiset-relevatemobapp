...
namespace TreePager
{
    class TreePagerAdapter : PagerAdapter
    {
        ...
        TabMenuActivity parentActivity;
        ...
        public override Java.Lang.Object InstantiateItem(View container, int position)
        {
            ...
            if (position == 0)
            {
                ...
                CustomListViewOffersAdapter adapter = new CustomListViewOffersAdapter(context, offerList, parentActivity);
        ...
        private void ListViewOffers_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            var intent = new Intent(context, typeof(OfferActivity));
